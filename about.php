  ...
  <div class="container">
    ...
    <div class="row">
      <div class="affiliate-text text-center text-light">
        <div class="sam-logo">
          <img src="assets/images/about/sam-about.png" />
        </div>
        <p>
...
<div class="section segment-sec pt-120">
  ...
  <div class="segment-main">
      ...
      <div class="row segment-repeater">
        <div class="col-lg-6 col-xs-12">
          <div class="img-segment">
            <img src="assets/images/about/digital-img.jpg" />
          </div>
        </div>
        <div class="col-lg-6 col-xs-12">
      ...
      <div class="row segment-repeater">
        ...
        <div class="col-lg-6 col-xs-12">
          <div class="img-segment">
            <img src="assets/images/about/creative-img.jpg" />
          </div>
        </div>
      </div>
      <!-- 3 -->
      <div class="row segment-repeater">
        <div class="col-lg-6 col-xs-12">
          <div class="img-segment">
            <img src="assets/images/about/develop-img.jpg" />
          </div>
        </div>
        <div class="col-lg-6 col-xs-12">
          <div class="cont-segment">
      ...
      <div class="row segment-repeater">
        ...
        <div class="col-lg-6 col-xs-12">
          <div class="img-segment">
            <img src="assets/images/about/enterprise-img.jpg" />
          </div>
        </div>
      </div>
  </div>
