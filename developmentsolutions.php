      ...
      <div class="row slider-text align-items-center justify-content-center">
        ...
        <div class="col-lg-6 col-sm-12 col-xs-12">
          <div class="img-in-ban">
            <img src="assets/images/development/development-img.png">
          </div>
        </div>
      </div>
    </div>
...
<div class="section creative-process pt-120 pb-120">
  <div class="container">
    ...
    <div class="crative-process">
      <!-- 1 -->
      <!-- <div class="row creative-one dev-one  hidden-xs hidden-sm">
        <div class="col-md-2">
        </div>
        <div class="col-md-2">
          <h4>Design</h4>
      ...
      <div class="row creative-two dev-two hidden-xs hidden-sm">
        <div class="col-md-12">
          <div class="img-process">
            <img class="" src="assets/images/development/process.png">
          </div>
        </div>
      </div>
      <!-- 3 -->
  ...
  <div class="container paragon-main">
    ...
    <div class="row repeatr-paragon">
      ...
      <div class="col-lg-6 col-md-6 col-sm-4 col-xs-12 image-paragon">
          <img src="./assets/images/development/web.png">
      </div>
    </div>
    <!-- 2 -->
    <div class="row repeatr-paragon">
      <div class="col-lg-6 col-md-6 col-sm-4 col-xs-12 image-paragon">
          <img src="./assets/images/development/app.png">
      </div>
      <div class="col-lg-6 col-md-6 col-sm-8 col-xs-12 cont-paragon">
          <div>
    ...
    <div class="row repeatr-paragon">
      ...
      <div class="col-lg-6 col-md-6 col-sm-4 col-xs-12 image-paragon">
          <img src="./assets/images/development/vr.png">
      </div>
    </div>
  </div>
</div>
          ...
          <div class="row-digital-portfolio">
            <div class="digital-port-main digital-port-main1">
              ...
              <div class="digital-port-repeater">
                <div class="row">
                  <div class="port-dig-img col-md-12">
                    <img src="./assets/images/portfolio/app-development/app-port-1.jpg">
                  </div>
                  <div class="col-md-2 port-small-img">
                    <div class="">
              ...
              <div class="digital-port-repeater">
                <div class="row">
                  <div class="port-dig-img col-md-12">
                    <img src="./assets/images/portfolio/app-development/app-port-2.jpg">
                  </div>
                  <div class="col-md-2 port-small-img">
                    <div class="">
