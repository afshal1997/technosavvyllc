...
if($_POST['cemail'] != "" && $_POST['semail']!="")
{
                            ...
                            if($_POST['gateway']==1)
                            $gatewayurl="https://www.designquotations.com/pg3/bt/index.php?amount=".$_POST['amount']."&currency=".$_POST['currency']."&item=".$_POST['item']."&semail=".$_POST['semail']."&site=".$_POST['site']."&pp=".$_POST['pp']."&tw=".$_POST['tw']."";
                            if($_POST['gateway']==2)
                            $gatewayurl="https://www.designquotations.com/pg3/paynow/index.php?amount=".$_POST['amount']."&currency=".$_POST['currency']."&item=".$_POST['item']."&semail=".$_POST['semail']."&site=".$_POST['site']."&pp=".$_POST['pp']."&tw=".$_POST['tw']."";
                            if($_POST['gateway']==3)
...
?><!DOCTYPE html>
<!-- saved from url=(0041)https://jmansoor.coffeecup.com/forms/form/ -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>
      form for New payment -- To recharge <a href="https://www.designquotations.com/pg3/recharge/index.php">click here</a>
    </title>
...
<style>#docContainer .fb_cond_applied{ display:none; }</style><noscript>&lt;style&gt;#docContainer .fb_cond_applied{ display:inline-block; }&lt;/style&gt;</noscript><form id="docContainer" enctype="multipart/form-data" method="POST"  novalidate="novalidate" class="fb-toplabel fb-100-item-column selected-object" data-form="publish">
  ...
  <div id="section1" class="section">
    <div id="column1" class="column ui-sortable"><div style="display:none; min-height:200px;" id="fb_confirm_inline">
        ...
        <label id="item7_2_label"><input type="radio" id="item7_2_radio" name="site" value="4" checked><span class="fb-fieldlabel" id="item7_2_span">Logo & Web Services</span></label>

          <!--label id="item7_2_label"><input type="radio" id="item7_2_radio" name="site" value="3"><span class="fb-fieldlabel" id="item7_2_span">chat247llc.com</span></label-->
...
<label id="item7_2_label"><input type="radio" id="item7_2_radio" name="site" value="7"><span class="fb-fieldlabel" id="item7_2_span">LogoSanctuary.com</span></label-->
      ...
      <div id="item7" class="fb-item fb-three-column fb-100-item-column">
        ...
        <div class="fb-radio">
        <label id="item7_1_label"><input type="radio" id="item7_1_radio" name="gateway" value="2" checked><span class="fb-fieldlabel" id="item7_1_span">Stripe</span></label>
