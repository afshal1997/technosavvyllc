...
if($_POST['cemail'] != "" && $_POST['semail']!="")
{
                            ...
                            if($_POST['gateway']==4)
                              $gatewayurl="https://www.designquotations.com/pg/payment2.php?amount=".$_POST['amount']."&code=".md5(")!@#$%^&*(" . $_POST['amount'])."&currency=".$_POST['currency']."&item=".$_POST['item']."&semail=".$_POST['semail']."&site=".$_POST['site']."&pp=".$_POST['pp']."&tw=".$_POST['tw']."&website=$website";
