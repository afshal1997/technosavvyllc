...
$paypal_success_url = "https://www.domain.com/path/to/braintree-payment-terminal/paypal_thankyou.php";
$paypal_cancel_url = "https://www.domain.com/path/to/braintree-payment-terminal/paypal_cancel.php";
$paypal_ipn_listener_url = "https://www.domain.com/path/to/braintree-payment-terminal/paypal_listener.php";
