...
$sql = mysql_query("INSERT INTO `transaction` VALUES ('','$customer_id','$email','$semail','$amount','$currency','$item_description','$statementdescriptor') ");
  ...
  include '/home/octapay/public_html/pg/pntest/includes/teamwork/teamwork.php';
                    ...
                    switch ($stripe_success) {
                        ...
                        case 1:  // Successs
                            ...
                            ******************************************************************/
                            ...
                            $message =  "<a href='$teamworkurl'>Team Work project created. Click here to access it</a> <br>New payment was successfully received through Stripe.com  Customer ID: ".$customer_id." Last 4 digit $last4 <br />";
