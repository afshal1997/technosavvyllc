 ...
 *  jQuery Mobile - https://code.jquery.com/mobile/1.0.1/jquery.mobile-1.0.1.min.js
 *  jQuery Mobile themes -  https://code.jquery.com/mobile/1.0.1/jquery.mobile-1.0.1.min.css
 *
 * Setup:
 *  $('.ui-keyboard-input')
 *   .keyboard(options)
...
$.keyboard = $.keyboard || {};
	...
	$.fn.addScramble = function(options) {
		...
		return this.each(function() {
			...
			// modified from Fisher-Yates shuffle ( https://bost.ocks.org/mike/shuffle/ )
