...
class Braintree_TransactionTest extends PHPUnit_Framework_TestCase
{
    ...
    function testSale_withAllAttributes()
    {
      ...
      $this->assertEquals('https://braintreepayments.com', $transaction->customerDetails->website);
    ...
    function testSale_storeInVault()
    {
        $transaction = Braintree_Transaction::saleNoValidate(array(
            ...
            'customer' => array(
                ...
                'phone' => '419-555-1234',
                'fax' => '419-555-1235',
                'website' => 'https://getbraintree.com'
            ),
            'options' => array(
                'storeInVault' => true
            )
        ...
        $this->assertEquals('https://getbraintree.com', $customer->website);
    }
