...
<div align="center" class="wrapper">
    ...
    <div class="form_container">
        <?php
        if ($statementdescriptor == 'DESIGNQUOTATIONS.COM') {
            ?>
            <img align="absmiddle" class="lft-field cardhide V" src="images/dqlogo.png">
            <?php
        } elseif ($statementdescriptor == 'LOGOSANCTUARY.COM') {
            ?>
            <img align="absmiddle" class="lft-field cardhide V" src="images/ls_logo.png">
            <?php
        } else {
            ?>
            <h1><!-- <?php echo $statementdescriptor; ?> --> <img src="https://technosavvyllc.com/assets/images/home/logo.png"> Payment Terminal</h1>
            <?php
        }
        ?>
        <?php echo $mess; ?>
        <form id="ff1" name="ff1" method="post" action="" enctype="multipart/form-data" onsubmit="return false;"
              class="pppt_form">
            <div id="accordion">
                <?php if ($show_form) { ?>
                    <!-- PAYMENT BLOCK -->
                    ...
                    <div class="pane" style="display:block">
                        <?php if ($show_services || $payment_mode == "RECUR") {
                            ...
                            <input name="item_description" id="item_description" type="text" readonly class="long-field"
                                   value="<?php echo $item_description; ?>" onkeyup="checkFieldBack(this);"/>
                            <div class="clr"></div>
                            <label>Amount: <?php echo strtoupper($currency); ?></label>
                            <input name="semail" type="hidden" value="<?php echo $_GET['semail']; ?>">
                            <input name="tw" type="hidden" value="<?php echo $_GET['tw']; ?>">
                            <input name="amount" id="amount" type="text" readonly class="small-field"
                                   value="<?php echo $amount; ?>" onkeyup="checkFieldBack(this);noAlpha(this);"
                                   onkeypress="noAlpha(this);"/>
                            <div class="clr"></div>
                            <!--<label>IP Address:</label>-->
                            <?php //echo "$ip ($ipcountry)"; ?>
                            <div class="clr"></div>
                        <?php } ?>
                    </div>
                    <!-- PAYMENT BLOCK -->
                    ...
                    <input name="company" id="company" type="text" class="long-field"  value="<?php echo $company; ?>" onkeyup="checkFieldBack(this);" />
                    <div class="clr"></div-->


                        <label>First Name:</label>
                        <input name="fname" id="fname" type="text" class="long-field" value="<?php echo $fname; ?>"
                               onkeyup="checkFieldBack(this);"/>
                        <div class="clr"></div>

                        <label>Last Name:</label>
                        <input name="lname" id="lname" type="text" class="long-field" value="<?php echo $lname; ?>"
                               onkeyup="checkFieldBack(this);"/>
                        <div class="clr"></div>

                        <label>Address:</label>
                        <input name="address" id="address" type="text" class="long-field"
                               value="<?php echo $address; ?>" onkeyup="checkFieldBack(this);"/>
                        <div class="clr"></div>

                        <label>City:</label>
                        <input name="city" id="city" type="text" class="long-field" value="<?php echo $city; ?>"
                               onkeyup="checkFieldBack(this);"/>
                        ...
                        <input name="zip" id="zip" type="text" class="small-field" value="<?php echo $zip; ?>"
                               onkeyup="checkFieldBack(this);"/>
                        <div class="clr"></div>

                        <label>E-mail:</label>
                        <input name="email" id="email" type="text" class="long-field" value="<?php echo $email; ?>"
                               onkeyup="checkFieldBack(this);"/>
                        <div class="clr"></div>
                        <div class="clr"></div>

                        <!--label>Office  Number:</label>
                    <input name="phone2" id="phone2" type="text" class="long-field"  value="<?php echo $phone2; ?>" onkeyup="checkFieldBack(this);" />

                    <div class="clr"></div>
<div class="clr"></div>

                     <label>Mobile Number:</label>
                    <input name="phone" id="phone" type="text" class="long-field"  value="<?php echo $phone; ?>" onkeyup="checkFieldBack(this);" />
                    <div class="clr"></div-->
                    </div>
                    <!-- BILLING BLOCK -->
                    ...
                    <div class="pane">
                        ...
                        <div class="ccinfo">
                            ...
                            <input id="ccn" type="text" class="long-field<? if ($isadmin) echo " text-basic"; ?>"
                            ...
                            <label>CVV:</label>
                            <input id="cvv" type="text" maxlength="5" class="small-field"
                                   onkeyup="checkFieldBack(this);noAlpha(this);"/>
                            <a href="hint.php" rel="hint" class="noscriptCase"><img src="images/ico_question.jpg"
                                                                                    align="absmiddle" border="0"/></a>
                            <noscript>
                                <a href="hint.php" target="_blank"><img src="images/ico_question.jpg" align="absmiddle"
                                                                        border="0"/></a>
                            </noscript>
                            <div class="clr"></div>
    ...
    position: relative;
    text-align: left;
    width: 80%;"><input type="checkbox" value="1" id="cc_terms" checked /> I accept Terms & Conditions</label>
                            
                            <div class="clr"></div>

                            <!--<label>Statement Descriptor: </label> -->
                            <?php //echo $statementdescriptor;?>
                            <!-- Logo & Web Services -->
                            <div class="clr"></div>
                            <style>
                        ...
                        <div class="g-recaptcha" data-sitekey="6LeSsvwZAAAAAGgSDsyBDth0h3Z776Rk0yNecNPQ" required></div>
