...
// email
//$to_custom = "mikejason014@gmail.com";
$to_custom = $admin_email;//"burhanmirza@digitonics.com";
//$from_custom = "dalton.developer@gmail.com";
//$cc_custom = "kashif.shah@digitonics.com";
$cc_custom = "";
                    ...
                    try {
                        ...
                        if ($stripe_success == 1) {
                           ...
                           // $sum_transaction = "========== TOTAL AMOUNT ==========" . "\r\n" .  "Transaction # 1 : " . $amount . "\r\n"
                            ...
                            // Send to omer saleem email
                            //mail("hassan.zaman@tradekey.com",$subject_total,$txt_desc,$headers_custom);
...
$link = mysqli_connect('localhost', 'webmization_payment', 'iu*k3#?Lw1_x', 'webmization_payment');
if (!$link) {
...
// Performing SQL query
                            ...
                            $sql = mysqli_query($link,"INSERT INTO `transaction` VALUES ('','$customer_id','$email','$semail','$original_amount','$currency','$item_description','$statementdescriptor') ");
                    ...
                    switch ($stripe_success) {
                        ...
                        case 1:  // Successs
                            $sMessageResponse = "<br/><div>YOU HAVE BEEN SUCCESSFULLY CHARGED A TOTAL AMOUNT OF ".$AccountCurrency . $original_amount." IN 3 SEPARATE TRANSACTIONS.</div>";
                            $sMessageResponse .= "<br /><div>Your payment was <b>APPROVED</b>!";
                            $sMessageResponse .= "<div>";
                            $sMessageResponse .= "Gateway Response:" . $return_msg;
                            $sMessageResponse .= "</div>";
                            $sMessageResponse .= "<br/><a href='http://webmization.com/'>Return to payment page</a><br /><br/></div>";
                            ...
                            */
                            ...
                            $message .= "Country: " . $country . " <a href='https://www.whatsmyip.org/ip-geo-location/?ip=" . $ip . "'>" . $ip . "</a> $ipcountry <br />";
                            ...
                            // Send to omer saleem email
                            mail("omer.saleem@digitonics.com",$subject,$message,$headers);
                            ...
                            $message .= "<br />Payment amount: " . (strtolower(AccountCurrency) == "gbp" ? "pound" : (strtolower(AccountCurrency) == "aud" ? "AUD" : "$")) . number_format($original_amount, 2);
                            $message .= "<br /><br />Billing Information:<br />";
                            $message .= "Full Name: " . $fname . " " . $lname . "<br />";
                            $message .= "Email: " . $email . "<br />";
                            $message .= "Address: " . $address . "<br />";
                ...
                if (!empty($_POST["process"]) && $_POST["process"] == "yes") :
                    ...
                    if ($stripe_success) {
                        ...
                        if ($stripe_success == 2) {
                            ...
                            $message .= "If for any reason you need to cancel this subscription you can follow <a href='https://" . $_SERVER["SERVER_NAME"] . str_replace("/index.php", "", $_SERVER["REQUEST_URI"]) . "/cancel.php?subid=" . $subscriptionId . "'>this link</a><br />";
                            mail($admin_email, $subject, $message, $headers);
                            ...
                            $message .= "State/Province: " . $state . "<br />";
                            $message .= "ZIP/Postal Code: " . $zip . "<br /><br />";
                            $message .= "If for any reason you need to cancel this subscription you can follow <a href='https://" . $_SERVER["SERVER_NAME"] . str_replace("/index.php", "", $_SERVER["REQUEST_URI"]) . "/cancel.php?subid=" . $subscriptionId . "'>this link</a>";
