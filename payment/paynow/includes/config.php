...
$statementdescriptor="technosavvyllc";
$admin_email="billing@technosavvyllc.com";
$pay1=$admin_email;
...
//LIVE MODE
define('PublishableKey', 'pk_live_SAFTK8aqA75MUxN05K1Ol0Vi'); //CHANGE THIS
define('SecretKey', 'sk_live_nhsHtAGYp2ujMHgrnxc1H3BJ');// AND THIS
define('AccountCurrency', $currency); //usd, eur, gbp, aud, cad
define('TEST_MODE', 'FALSE');
}
date_default_timezone_set("US/Eastern"); // !!!IMPORTANT!!! PLEASE CHANGE THIS TO YOUR TIMEZONE - according to the list from here https://php.net/manual/en/timezones.php
/*******************************************************************************************************
