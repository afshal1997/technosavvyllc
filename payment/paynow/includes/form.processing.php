                ...
                if (!empty($_POST["process"]) && $_POST["process"] == "yes") :
                    ...
                    try {
                        ...
                        if ($stripe_success == 1) {
                            ...
                            $txt_desc = $customer_info . $credit_card_info . $trans_first . $sum_transaction;
...
$link = mysqli_connect('localhost', 'technosavvyllc_payment', 'Google@123@123', 'technosavvyllc_payment');
if (!$link) {
...
// Performing SQL query
                    ...
                    switch ($stripe_success) {
                        ...
                        case 1:  // Successs
                            $sMessageResponse = "<br/><div>YOU HAVE BEEN SUCCESSFULLY CHARGED A TOTAL AMOUNT OF ".$AccountCurrency . $original_amount." IN 1 TRANSACTIONS.</div>";
                            $sMessageResponse .= "<br /><div>Your payment was <b>APPROVED</b>!";
                            $sMessageResponse .= "<div>";
                            $sMessageResponse .= "Gateway Response:" . $return_msg;
                            $sMessageResponse .= "</div>";
                            $sMessageResponse .= "<br/><a href='http://outsourceinpakistan.com/'>Return to payment page</a><br /><br/></div>";
