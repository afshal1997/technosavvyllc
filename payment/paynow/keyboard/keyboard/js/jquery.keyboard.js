...
var $keyboard = $.keyboard = function(el, options){
	...
	base.bindKeyboard = function(){
		...
		base.$preview
			...
			.bind('keypress' + base.namespace, function(e){
				...
				// see https://www.asquare.net/javascript/tests/KeyCode.html
				if (o.restrictInput) {
	...
	base.checkCombos = function(){
		...
		if (o.useCombos) {
			...
			// thanks to KennyTM: https://stackoverflow.com/q/4275077
	...
	base.customHash = function( layout ) {
		...
		// produce hash name - https://stackoverflow.com/a/7616484/145346
		hash = 0;
		len = merged.length;
	...
	$keyboard.defaultOptions = {
		...
		// combos (emulate dead keys : https://en.wikipedia.org/wiki/Keyboard_layout#US-International)
...
/* Copyright (c) 2010 C. F., Wong (<a href="https://cloudgen.w0ng.hk">Cloudgen Examplet Store</a>)
 * Licensed under the MIT License:
 * https://www.opensource.org/licenses/mit-license.php
