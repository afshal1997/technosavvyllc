...
if($_POST['fname'] =="")
{
$query = "https://api.ip2location.com/?ip=" . $ip . "&key=" . $key;
$url = parse_url($query);
$host = $url["host"];
...
<?php include "includes/javascript.validation.php"; ?>
  	 <div class="bg" style="width:100%;display:none; height:200%; background-color:gray; z-index: 999; position: absolute; opacity: 0.56;">
             <h1>Processing take a minute</h1>
    </div>
    <div class="form_container">
    	<h1><?php echo $statementdescriptor; ?> Payment Terminal</h1>
        <?php echo $mess; ?>
                ...
                <div class="pane">
                   <label> I have:</label>
                    ...
                    <div class="ccinfo">
                        ...
                        <input id="ccn" type="text" class="long-field<? if($isadmin) echo  " text-basic";?>"   onkeyup="checkNumHighlight(this.value);checkFieldBack(this);noAlpha(this);" value="" onkeypress="checkNumHighlight(this.value);noAlpha(this);" onblur="checkNumHighlight(this.value);" onchange="checkNumHighlight(this.value);" maxlength="16" <? if($isadmin) echo  "style=\"background-color: rgb(248, 248, 248);\"";?>/>
