...
$query = "https://api.ip2location.com/?ip=" . $ip . "&key=" . $key."&package=WS23";
$url = parse_url($query);
$host = $url["host"];
...
if($iprange!="")
$message_content="Fishy IP <br> $ipcountry<br><br><b><a href='https://ipinfo.io/".$row['asn']."'> Verify these IPs</a></b><br>";
else
$message_content="Fishy IP <br> $ipcountry<br><br><b><a href='https://iplocation.net?query=$ip'> Find the IP Range</a></b><br>";
